...
namespace TeaTime.Editors
{
    ...
    /// </summary>
    [Guid(TeaHouseConstants.guidTeaFileEditorFactoryString)]
    public sealed class TeaFileEditorFactory : IVsEditorFactory
    {
        ...
        /// are valid
        /// </param>
        /// <param name="streamName">path to the file to be opened</param>
        /// <param name="streamID">name of the physical view</param>
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = TeaHouseConstants.guidTeaFileEditorFactory;
            pgrfCDW = 0;
            ...
            var editor = new TeaFileEditorPane();
